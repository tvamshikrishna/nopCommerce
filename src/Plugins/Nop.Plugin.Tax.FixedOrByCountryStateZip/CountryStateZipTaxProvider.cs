...
namespace Nop.Plugin.Tax.FixedOrByCountryStateZip
{
    ...
    /// </summary>
    public class FixedOrByCountryStateZipProvider : BasePlugin, ITaxProvider
    {
        ...
        public FixedOrByCountryStateZipProvider(ITaxRateService taxRateService,
        ...
        public CalculateTaxResult GetTaxRate(CalculateTaxRequest calculateTaxRequest)
        {
            ...
            if (!_countryStateZipSettings.Enabled)
            {
        ...
        public override void Install()
        {
            ...
            //settings
            var settings = new CountryStateZipSettings
            {
                Enabled = false
            };
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Tax.FixedOrByCountryStateZip.AddRecord.Hint", "Adding a new tax rate");
        ...
        public override void Uninstall()
        {
            ...
            //settings
            _settingService.DeleteSetting<CountryStateZipSettings>();
            ...
            this.DeletePluginLocaleResource("Plugins.Tax.FixedOrByCountryStateZip.AddRecord.Hint");
